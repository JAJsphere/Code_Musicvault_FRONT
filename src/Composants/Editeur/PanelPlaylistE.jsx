...
export default function PanelPlaylistE() {
              ...
              playlistsAffichees.map((playlist) => (
                ...
                <div key={playlist.idPlaylist} className="PPA-playlist-card">
                  ...
                  <div className="PPA-playlist-actions">
                    ...
                    <button
                      onClick={() =>
                        navigate(`/Eplaylist/${playlist.idPlaylist}`, { state: { nom: playlist.nom } }) // State -> Permet de transmettre des données à la page de destination sans les mettre dans l'URL. 
