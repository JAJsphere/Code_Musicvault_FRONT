...
export default function PanelMusiqueE() {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const res = await fetch(`${API_URL_FETCH}/AP_PILLA/PHP_API_BACK/API/MusiqueActions.php`, {
                ...
                body: JSON.stringify(musiqueEdit), /* Corps -> contient mes modifications à envoyer au serveur pour qu'il mette à jour la musique correspondante 
